...
\hypersetup{
  ...
  pdfsubject={A computer-assisted proof, formally verified in Lean 4, of the Chen-Larson nonvanishing predictions (one corrected)},
...
\large A computer-assisted proof, formally verified in Lean~4, with a correction to the Chen--Larson derivation}
...
All of the resulting power-series statements --- the part of the argument that
is not classical algebraic geometry --- are formally verified in \Lean{}~4 and
Mathlib; the only non-standard part of the trusted base is the compiler invoked
by \code{native\_decide} for the large finite computations.  We also describe
the substantial role of long-horizon generative-AI assistance in finding and
checking the proof, including the AI audit that uncovered the error above.
\end{abstract}
