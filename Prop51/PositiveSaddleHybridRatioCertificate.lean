...
/-- Concrete preferred large-tail tail shape after the candidate side has
been filled by the hybrid-ratio prefix certificates and the upper-middle
reverse certificate.

The remaining fields are exactly the strengthened upper-edge/lower-`N`
split-factorial product target and the upper-edge split-factorial
ten-sevenths solo target.  This records a Lean proof-production
specialization of the TeX-facing scalar estimates, not a new mathematical
estimate.
-/
structure PositiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate :
    Prop where
  product :
    PositiveSaddleLargeTailProductClosedFactorialSplitBlockSumScalarFastExpUpperEdgeLowerNCertificate
  soloY :
...
theorem PositiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate.toTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloEnvelopeBoundsAuditCertificate
    (cert :
  ...
  positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedCertificate_of_productClosedFactorialSplitBlockSumScalarsFastExpUpperEdgeLowerN_soloGcompClosedFactorialSplitBlockSumTenSeventhsCleared_upperEdge
    cert.product cert.soloY

theorem PositiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate.toRefinedAtomicBoundsAuditCertificate
    (cert :
      PositiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate) :
  ...
  cert.toTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloEnvelopeBoundsAuditCertificate
    |>.toRefinedAtomicBoundsAuditCertificate

theorem PositiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate.toLargeTailAuditCertificate
    (cert :
      PositiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate) :
    PositiveSaddleLargeTailAuditCertificate :=
...
/-- Build the preferred concrete hybrid-ratio tail from prefix/large hybrid
certificates for the strengthened product target and the fast upper-edge solo
target.

The finite prefix strip `2000 < a < 3000` is supplied by generated Boolean
chunks; the `3000 ≤ a` side remains as the explicit analytic fields of the
two hybrid certificates. -/
theorem positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate_of_productFastUpperEdgeLowerNHybrid_soloFastUpperEdgeHybrid
    {productALen productKLen soloALen : Nat}
    (product :
      PositiveSaddleLargeTailProductFastUpperEdgeLowerNHybridCertificate
        productALen productKLen)
    (soloY :
      PositiveSaddleLargeTailSoloFastUpperEdgeHybridCertificate soloALen) :
    PositiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate :=
  positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate_of_soloFastUpperEdge
    product.toUpperEdgeLowerNCertificate soloY.toUpperEdge

/-- Build the preferred concrete hybrid-ratio tail from surrogate product
and solo bound certificates.

This is the practical endpoint for generated rational upper bounds: the
expensive split-factorial sums are bounded separately, while the final
budget checks only involve the supplied rational surrogates. -/
theorem positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate_of_productFastUpperEdgeLowerNProductBound_soloFastUpperEdgeBound
...
/-- Build the preferred concrete hybrid-ratio tail from prefix/large hybrid
surrogate certificates for the final product and solo budgets. -/
theorem positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate_of_productFastUpperEdgeLowerNProductBoundHybrid_soloFastUpperEdgeBoundHybrid
    {xyBound : Nat → Nat → ℚ} {soloBound : Nat → ℚ}
    {productALen productKLen soloALen : Nat}
    (product :
      PositiveSaddleLargeTailProductFastUpperEdgeLowerNProductBoundHybridCertificate
        xyBound productALen productKLen)
    (soloY :
...
/-- Build the preferred concrete hybrid-ratio tail from prefix/large hybrid
surrogate certificates that estimate the upper-edge `X` and `Y` factors
separately, together with a surrogate solo certificate. -/
theorem positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate_of_productFastUpperEdgeLowerNXYBoundHybrid_soloFastUpperEdgeBoundHybrid
...
/-- Audit-certificate wrapper for prefix/large hybrid certificates proving
the strengthened product target and the fast upper-edge solo target. -/
theorem positiveSaddleLargeTailAuditCertificate_of_productFastUpperEdgeLowerNHybrid_soloFastUpperEdgeHybrid
    {productALen productKLen soloALen : Nat}
    (product :
      PositiveSaddleLargeTailProductFastUpperEdgeLowerNHybridCertificate
        productALen productKLen)
    (soloY :
      PositiveSaddleLargeTailSoloFastUpperEdgeHybridCertificate soloALen) :
    PositiveSaddleLargeTailAuditCertificate :=
  (positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate_of_productFastUpperEdgeLowerNHybrid_soloFastUpperEdgeHybrid
    product soloY).toLargeTailAuditCertificate

/-- Audit-certificate wrapper for surrogate product and solo bound
certificates. -/
theorem positiveSaddleLargeTailAuditCertificate_of_productFastUpperEdgeLowerNProductBound_soloFastUpperEdgeBound
    {xyBound : Nat → Nat → ℚ} {soloBound : Nat → ℚ}
    (product :
      PositiveSaddleLargeTailProductFastUpperEdgeLowerNProductBoundCertificate
        xyBound)
...
/-- Audit-certificate wrapper for prefix/large hybrid surrogate product and
solo bound certificates. -/
theorem positiveSaddleLargeTailAuditCertificate_of_productFastUpperEdgeLowerNProductBoundHybrid_soloFastUpperEdgeBoundHybrid
    {xyBound : Nat → Nat → ℚ} {soloBound : Nat → ℚ}
    {productALen productKLen soloALen : Nat}
    (product :
      PositiveSaddleLargeTailProductFastUpperEdgeLowerNProductBoundHybridCertificate
    ...
    (soloY :
      PositiveSaddleLargeTailSoloFastUpperEdgeBoundHybridCertificate
        soloBound soloALen) :
    PositiveSaddleLargeTailAuditCertificate :=
  (positiveSaddleLargeTailTemperedSharpTopOffsetHybridRatioChunkedUpperMiddleExpTargetTenSeventhsClosedReserveSoloUpperEdgeProductUpperEdgeLowerNBoundsAuditCertificate_of_productFastUpperEdgeLowerNProductBoundHybrid_soloFastUpperEdgeBoundHybrid
    product soloY).toLargeTailAuditCertificate

/-- Audit-certificate wrapper for prefix/large hybrid surrogate certificates
that estimate the upper-edge `X` and `Y` factors separately. -/
theorem positiveSaddleLargeTailAuditCertificate_of_productFastUpperEdgeLowerNXYBoundHybrid_soloFastUpperEdgeBoundHybrid
    {xBound yBound : Nat → Nat → ℚ} {soloBound : Nat → ℚ}
    {productALen productKLen soloALen : Nat}
    (product :
      PositiveSaddleLargeTailProductFastUpperEdgeLowerNXYBoundHybridCertificate
